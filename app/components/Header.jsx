    ...
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      <div>
        <Image src={assets.profile_img} alt='' className='rounded-full w-32' />
         ...
         I am a Full-stack developer and 3rd-year Software Engineering student at NSBM Green University. 
         Skilled in React, Node.js, MongoDB, and more, with a passion for building efficient web applications.    
         </p>
